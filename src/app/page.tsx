...
export default function Home() {
	...
	return (
		<div className="min-w-screen min-h-screen bg-primary/15 flex items-center justify-center">
			<main
				className="text-primary w-10/12 md:max-w-92 flex flex-col items-center bg-white shadow-md 
      px-3 py-6 rounded-md animate-fadeIn"
			>
				...
				<h1 className="flex flex-col items-center text-3xl font-semibold leading-7 mt-6 text-black">
					Votaciones
					<span className="text-base text-primary/80">CGAO</span>
				</h1>
				...
				<Loader className="text-primary size-10 mt-4" />
			</main>
		</div>
	)
}
