	...
	return (
		<>
			<div className="w-11/12 md:max-w-[600px] mx-auto flex flex-col justify-center items-center mt-10">
				<div className="p-2 bg-primary/20 rounded-full [&_svg]:size-6 [&_svg]:text-primary dark:[&_svg]:text-dark-primary border border-primary/20 dark:border-dark-primary/20 md:[&_svg]:size-8">
					<Calendar />
				</div>
				<div className="flex flex-col md:items-center border border-primary/40 rounded p-5 mt-6 dark:border-dark-primary/40">
					...
					<div className="flex md:flex-row flex-col items-center justify-center gap-2 mt-6 w-full [&_button]:w-full [&_button]:md:w-fit [&_button]:rounded [&_button]:text-sm [&_button]:px-3 [&_button]:py-2 [&_button]:border [&_button]:transition-colors [&_button]:cursor-pointer [&_button]:flex [&_button]:items-center [&_button]:justify-center [&_button]:gap-1 [&_button_svg]:size-5">
						<button
							type="button"
							className="bg-primary hover:bg-primary/80 dark:bg-dark-primary/80 dark:hover:bg-dark-primary/60 border-none active:bg-primary/60 active:dark:bg-primary/60"
					...
					<div className="mt-6 text-xs w-full bg-primary/20 rounded p-2 border border-primary/40 flex flex-col  dark:bg-primary/20 dark:border-primary/40">
